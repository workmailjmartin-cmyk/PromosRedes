document.addEventListener('DOMContentLoaded', () => {
    ...
    // ===========================================================
    // 3. FUNCIONES DE LÓGICA & CALENDARIO
    // ===========================================================
    ...
    window.openCalendarModal = async (dayKey, dayName) => {
        ...
        try { 
            ...
            // Usamos la clase 'active' para mostrarlo (CSS)
            dom.modalCalendar.classList.add('active'); 
    ...
    if(dom.btnSaveCalendar) {
        dom.btnSaveCalendar.onclick = async () => {
            ...
            try {
                ...
                dom.modalCalendar.classList.remove('active'); // Ocultar Modal
                await loadCalendar(); // Recargar visual
                showLoader(false);
            } catch (e) {
                showLoader(false);
    ...
    if(dom.btnCloseCalendar) {
        dom.btnCloseCalendar.onclick = () => dom.modalCalendar.classList.remove('active');
    }
    ...
    // Función Globalizada para el HTML onClick
    ...
    // ===========================================================
    // 5. CARGA DE DATOS & AUTH (AL FINAL)
    // ===========================================================
    ...
    async function fetchAndLoadPackages() { 
        ...
        try { 
            ...
            applyFilters(); // AHORA SÍ ESTÁ DEFINIDA
            updatePendingBadge(); 
        } catch(e){ console.error(e); }
        showLoader(false);
    }
