document.addEventListener('DOMContentLoaded', () => {
    ...
    // ===========================================================
    // 2. FUNCIONES DE UTILIDAD Y UI (DEFINIR PRIMERO)
    // ===========================================================
    ...
    // ===========================================================
    // 3. LÓGICA DE NEGOCIO (NOCHES, ICONOS, TEXTOS)
    // ===========================================================
    ...
    // ===========================================================
    // 5. EVENTOS, FORMULARIO Y USUARIOS
    // ===========================================================
    if (dom.userForm) {
        ...
        if (u) {
            try {
                ...
                if (doc.exists) {
                    ...
                    configureUIByRole(); // FUNCIONA PORQUE YA FUE DEFINIDA ARRIBA
