    ...
    async function loadCalendar() {
        ...
        try {
            ...
            days.forEach((dayName, index) => {
                ...
                // Si está vacío y no es admin, mostrar guion
                let displayContent = content;
                if(!content && (!userData || userData.rol === 'usuario')) displayContent = '<span style="color:#ddd;">-</span>';
                if(!content && (userData.rol === 'admin' || userData.rol === 'editor')) displayContent = '<span style="color:#eee;">Clic para editar</span>';
        ...
        if (u) {
            try {
                ...
                if (doc.exists) {
                    ...
                    configureUIByRole(); 
                    await loadCalendar(); // CARGA CALENDARIO
